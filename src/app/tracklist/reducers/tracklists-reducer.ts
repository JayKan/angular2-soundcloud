...
export const tracklistsReducer: ActionReducer<TracklistsState> = (state: TracklistsState = initialState, action: Action): TracklistsState => {
  switch (action.type) {
    ...
    case UserActions.LOAD_USER_TRACKS:
      return state.withMutations(tracklists => {
        ...
        tracklists.set('currentTracklistId', tracklistId)
