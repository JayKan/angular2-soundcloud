...
const initialState: TimesState = new TimesStateRecord() as TimesState;

export const timesReducer: ActionReducer<TimesState> = (state: TimesState = initialState, { payload, type }: Action): TimesState => {
  switch (type) {
